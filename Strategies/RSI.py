...
def fetch_and_analyze_rsi(stock_ticker, start_date, end_date, initial_capital=100000, rsi_period=13, overbought=70, oversold=30):
    # 抓取股票數據
...
if __name__ == "__main__":
    ...
    fetch_and_analyze_rsi(stock_ticker, start_date, end_date, initial_capital)
